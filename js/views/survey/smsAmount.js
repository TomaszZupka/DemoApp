define([
		...
		'underscore',
		'backbone',
		'text!../../../templates/survey/smsAmount.html',
		'text!../../../templates/navpanel.html'
], function($, _, Backbone, tmpl, navtmpl) {

	var SmsAmountView = Backbone.View.extend({
		...
		render : function() {
			...
			$(this.el).find('a[href="#surveySmsAmount"]').addClass("ui-disabled");
